...
class AlipayController extends Controller {
    ...
    public function alipay2_wish(){
    	require_once("./pay/alipay2/alipayapi_wish.php");
    }
    public function alipay2_return_wish(){
    	require_once("./pay/alipay2/return_url_wish.php");
    }
    public function alipay2_notify_wish(){
    	require_once("./pay/alipay2/notify_url_wish.php");
    }
    public function alipay_wish(){
    	require_once("./pay/alipay/alipayapi_wish.php");
    }
    public function alipay_return_wish(){
    	require_once("./pay/alipay/return_url_wish.php");
    }
    public function alipay_notify_wish(){
    	require_once("./pay/alipay/notify_url_wish.php");
    }
    public function alipay_wap_wish(){
    	require_once("./pay/alipay/alipayapi_wish.php");
    }
    public function alipay_wap_return_wish(){
    	require_once("./pay/alipay_wap/call_back_url_wish.php");
    }
    public function alipay_wap_notify_wish(){
    	require_once("./pay/alipay_wap/notify_url_wish.php");
    }
    //财付通
    public function tenpay_wish(){
    	require_once("./pay/tenpay/tenpay_wish.php");
    }
    public function tenpay_return_wish(){
    	require_once("./pay/tenpay/payReturnUrl_wish.php");
    }
    public function tenpay_notify_wish(){
    	require_once("./pay/tenpay/payNotifyUrl_wish.php");
    }
}